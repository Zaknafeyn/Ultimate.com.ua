...
//clear users
  ...
  //import user groups
  $q = "SELECT ug.* FROM ".$dbnameSource.".".$dbPrefixSource.$table_name. " ug,".$dbnameSource.".".$dbPrefixSource."groups g WHERE g.group_id = ug.group_id AND g.group_single_user = 0";
  //echo "---$q---";
