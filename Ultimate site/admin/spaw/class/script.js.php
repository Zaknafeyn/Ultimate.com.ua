  ...
  function SPAW_image_prop_click(editor, sender)
  {
   ...
   function SPAW_file_click(editor, sender)
  {
   window.frames[editor+'_rEdit'].focus();     

    var file = showModalDialog('<?php echo $spaw_dir?>dialogs/file_library.php?lang=' + document.all['SPAW_'+editor+'_lang'].value + '&theme=' + document.all['SPAW_'+editor+'_theme'].value, '', 
      'dialogHeight:420px; dialogWidth:420px; resizable:no; status:no');
