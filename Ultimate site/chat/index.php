<?
    ...
    $lang = "ru";
    $TITLE_chat = "ЧАТ :: ULTIMATE ФРИЗБИ НА УКРАИНЕ (КИЕВ)";
	...
	if ($action=="register") {
        ...
        if ($new_id == "1"){
	        ...
	        if (($name != $t_name) ||
	        	...
	        	($pasw2 != $t_pasw2) ||
	        	($pasw1 != $pasw2)) {
                ?><center><h3 style="color:black">Логин или пароли заданы неправильно!</h3></center><?
	        	$err=1;
            } else {
	            ...
	            if (($count == 0)&&($err==0)) {
	                ...
	                ?><center>
	                    <table width="100%" cellpadding="5" cellspacing="1">
	                        <tr><td align="center"><h3 style="color:black">Вы успешно прошли регистрацию!</h3></td></tr>
	                        <tr><td>
	                            ...
	                            <table cellspacing="0" ceppladding="2" border="0" align="center">
	                                <tr><td><p class="f12b">Логин<br><input class="i" name=name value="<?php print $name; ?>" type=text></td><td>
	                                <tr><td><p class="f12b">Пароль<br><input class="i" name=pasw value="<?php print $pasw1; ?>" type=password></td><td>
	                                <tr><td align="center"><p><input class="b" value="Зайти в чат" type="Submit" style="cursor:hand;"></td></tr>
	                            </table>
	                            </form>
	                        </td></tr>
	                    </table>
	            ...
	            if (($count != 0)&&($err==0)){ ?><center><h3 style="color:black">Это имя уже занято!</h3></center><?php }
			}
	    }

?>

	<h2><a href="index.php">ЧАТ</a></h2>
    <form name="regform" action="index.php" method="POST">
	<input type="hidden" name="action" value="register">
	<table width="100%" cellpadding="5" cellspacing="1">
  	<tr><td align="center"><h3>Регистрация</h3></td>
    </tr>
		<tr>
    	<td valign="top" align="center">
      	<table>
      		<tr><td><p>Логин<br><input class="i" name="name" value="" type="text"></td></tr>
					<tr><td><p>Пароль<br><input class="i" name=pasw1 value="" type="password"></td></tr>
					<tr><td><p>Повторите пароль<br><input class="i" name=pasw2 value="" type="password"></td></tr>
	        <tr>
          	<td><p>Цвет ника
	            <br>
	            <select class="i" onchange="document.forms[0].nick_color.value = this.options[this.selectedIndex].value;">
	            <option value='000000'>- выберите -</option>
	            <?php
	        ...
	        <tr><td><p>e-mail<br><input class="i" type=text name="email" value='<?php echo $email; ?>' maxlength="30" size="15"></td></tr>
					<tr><td><p>Уточним <input type="radio" style="border: none;	width: 20px;" name="sex" value="m"><img src="/chat/images/i_m.gif" border=0>&nbsp;<input type="radio" style="border: none; width: 20px;" name="sex" value="w"><img src="/chat/images/i_w.gif" border=0></td></tr>
					<tr><td><p>Новые сообщения <input type="radio" style="border: none; width: 20px;" name="top2bot" value="0" checked>сверху&nbsp;<input type="radio" style="border: none; width: 20px;" name="top2bot" value="1">снизу</td></tr>
        </table>
      </td>
    </tr>
    <tr><td align=center>
	    <input type="hidden" name="new_id" value="1">
	    <input name="p_send" value="Зарегистрироваться" type="submit" style='cursor:hand;'><br>
    </td></tr>
  </table>
...
?>
	<table width=100% cellspacing=0 cellpadding=0 border=0>
		<tr valign=top>
            ...
            <td>
				<center><h2><a href="/chat/">ЧАТ</a></h2></center>
	            <table border="0" width="100%"><FORM METHOD=POST ACTION="index.php">
	                <tr align="center">
	                    <td width align="right">Логин:
	                    <INPUT style="width:80px;" TYPE="text" NAME="name"></td>
                    	<td align="left">Пароль:
	                    <INPUT style="width:80px;" TYPE="password" NAME="pasw"></td>
                    </tr>
	                <tr align="center">
                    	<td colspan="2" align="center"><INPUT style="width=100px;" TYPE="submit" NAME="submit" value="Вход"></td>
	                </tr></FORM>
	                <tr align="center">
                    	<td colspan="2" align="center">
                        	<form method="post" action="" name="f1">
							<input type="hidden" name="action" value="register">
                            <INPUT style="width=100px;" TYPE="submit" value="Регистрация">
                            </form>
                        </td>
	                </tr></FORM>
                </table>
        ...
        <tr>
        	<td colspan="2">
            	<table width="100%">
                	<tr><td>
            			<p><br /><h3>Последние сообщения в чате:</h3></p>
                    </td></tr>
